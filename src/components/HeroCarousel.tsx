...
const HeroCarousel: React.FC = () => {
  ...
  return (
    <section className="relative mt-20 overflow-hidden" style={{ minHeight: '420px' }}>
      ...
      >
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <Link
              to="/trilha"
              className="inline-flex items-center justify-center px-6 py-3 text-white font-semibold rounded-lg border-2 border-white hover:bg-white/10 transition duration-150 ease-in-out hover:-translate-y-[3px]"
            >
      ...
      <button
        onClick={prev}
        className="absolute left-2 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-black/20 hover:bg-black/40 flex items-center justify-center transition-colors"
      ...
      <button
        onClick={next}
        className="absolute right-2 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-black/20 hover:bg-black/40 flex items-center justify-center transition-colors"
