...
**Pergunta:** Como Python simula sobrecarga de métodos de forma nativa?

- [ ] Criando múltiplos métodos com o mesmo nome e assinaturas diferentes, como em Java.
- [x] Usando parâmetros com valor padrão, `*args`, `**kwargs` ou `@singledispatch`. ← correta
...
**Explicação:** Python usa parâmetros opcionais e empacotamento de argumentos como alternativa flexível à sobrecarga tradicional.
