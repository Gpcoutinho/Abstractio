...
**Pergunta:** Qual característica define uma relação de **Associação** entre objetos?

- [ ] Um objeto cria e destrói o outro durante seu ciclo de vida.
- [x] Os objetos se conhecem e interagem, mas existem de forma independente. ← correta
- [ ] Um objeto é parte estrutural do outro e não pode existir sozinho.
- [ ] Um objeto herda atributos e métodos do outro.

**Explicação:** Na associação, os objetos interagem mas são independentes — nenhum controla o ciclo de vida do outro.
