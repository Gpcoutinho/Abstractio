...
**Pergunta:** Por que é importante entender como objetos se relacionam em POO?

- [ ] Porque objetos isolados são mais eficientes computacionalmente.
- [x] Porque sistemas reais são formados por objetos que colaboram — entender relações é essencial para modelar o mundo real. ← correta
...
**Explicação:** Sistemas reais são redes de objetos colaborando. Modelar essas relações corretamente é o que torna um design robusto e manutenível.
