...
**Pergunta:** Qual é o principal benefício de usar contratos (interfaces/classes abstratas) em um sistema?

- [ ] Aumentar o desempenho do código em tempo de execução.
- [x] Garantir que diferentes classes implementem um conjunto comum de métodos, permitindo intercambialidade. ← correta
...
**Explicação:** Contratos garantem que qualquer classe que os implemente possa ser usada de forma intercambiável, tornando o sistema extensível e previsível.
